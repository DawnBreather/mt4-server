...
//+------------------------------------------------------------------+
//| Buy at market price                                              |
//| Syntax: BUY Symbol Lots MagicNumber                              |
//| Results:                                                         |
...
//| Syntax: SELL Symbol Lots MagicNumber                             |
//| Results:                                                         |
//|   Success: Order id (RespInteger)                                |
//|   Fail:    RespError                                             |
//+------------------------------------------------------------------+
...
public:
  ...
  {
    if (command.size() != 4)
      return new RespError("Invalid number of arguments for command SELL!");
    string symbol = dynamic_cast<RespBytes *>(command[1]).getValueAsString();
    double lots = StringToDouble(dynamic_cast<RespBytes *>(command[2]).getValueAsString());
...
public:
  RespValue *call(const RespArray &command)
  {
    if (command.size() != 3 && command.size() != 2)
      return new RespError("Invalid number of arguments for command CLOSE!");
...
public:
  ...
  {
    if (command.size() != 7)
      return new RespError("Invalid number of arguments for command SELLLIMIT!");
...
//| Syntax: BUYLIMIT Symbol Lots Price SL TP MagicNumber             |
//| Results:                                                         |
//|   Success: Order id (RespInteger)                                |
//|   Fail:    RespError                                             |
//+------------------------------------------------------------------+
...
public:
  ...
  {
    if (command.size() != 7)
      return new RespError("Invalid number of arguments for command BUYLIMIT!");
...
public:
  ...
  {
    if (command.size() != 4)
      return new RespError("Invalid number of arguments for command EDIT!");
...
public:
  RespValue *call(const RespArray &command)
  {
    ...
    if (command.size() != 1)
      return new RespError("Invalid number of arguments for command FREEMARGIN!");
